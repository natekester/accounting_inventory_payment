...
import (
	...
	*/
	...
	"github.com/natekester/inventory-payment-integration/backend/internal/modules/inventory/strategy"
	...
	*/
	...
	// _ "github.com/natekester/inventory-payment-integration/backend/internal/shared/eventbus"
)
...
func main() {
	...
	// 2. Initialize In-Memory EventBus (Temporarily disabled)
	...
	// Temporarily disabled for QBO sync focus
	/*
